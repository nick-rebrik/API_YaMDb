# Generated by Django 3.0.5 on 2021-06-18 19:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[
                 ('user', 'User'), ('moderator', 'Moderator'), ('admin', 'Admin')], default='user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100,
                 unique=True, verbose_name='Категория')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(
                    db_index=True, verbose_name='Год издания')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(
                score__range=(0, 10)), name='valid_rate'),
        ),
        migrations.AddConstraint(
            model_name='review',
